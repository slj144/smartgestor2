...
export class ProvidersService {
  ...
  private data: { [_id: string]: IRegistersProvider } = {};
  ...
  public query(where?: query['where'], reset: boolean = true, flex: boolean = false, scrolling: boolean = false, strict: boolean = true, others?: {back?: boolean, orderBy?: any }) {
    ...
    return (new Promise<IRegistersProvider[]>((resolve) => {
  ...
  public getProviders(listenerId: string, listener: ((_: any)=>void)) {
  ...
  public async registerProvider(data: IRegistersProvider, batch?: IBatch) {
  ...
  public async deleteProvider(data: IRegistersProvider, batch?: IBatch): Promise<void> {
  ...
  public getProvidersCount(listenerId: string, listener: ((_: any)=>void)) {
  ...
  private async systemLogs(data: IRegistersProvider, action: string, batch: IBatch, batchRef?: number) {
    ...
    settings.data[0].type = ESystemLogType.RegistersProviders;
  ...
  private collRef(settings?: query): ICollection {
    ...
    const collection = this.iToolsService.database().collection('RegistersProviders');
  ...
  private requestData(settings: query, strict: boolean) {
    ...
    return (new Promise<IRegistersProvider[]>((resolve, reject) => {
  ...
  private treatData(id: string, data?: IRegistersProvider[], order: 1 | -1 = 1) {
