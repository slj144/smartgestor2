...
// Translate
import { BillsToPayCategoriesTranslate } from "./bills-to-pay-categories.translate";

// Interfaces
import { IBatch } from '@itools/interfaces/IBatch';
import { ICollection } from '@itools/interfaces/ICollection';
import { IFinancialBillToPayCategory } from '@shared/interfaces/IFinancialBillToPayCategory';
...
export class BillsToPayCategoriesService {

  public translate = BillsToPayCategoriesTranslate.get();
  ...
  public async registerCategory(data: IFinancialBillToPayCategory, batch?: IBatch): Promise<void> {
  ...
  public async deleteCategory(data: IFinancialBillToPayCategory, batch?: IBatch): Promise<void> {
  ...
  private async systemLogs(data: IFinancialBillToPayCategory, action: string, batch: IBatch, batchRef?: number) {
    ...
    settings.data[0].type = ESystemLogType.FinancialBillsToPayCategories;
  ...
  private collRef(): ICollection {
    return this.iToolsService.database().collection('FinancialBillToPayCategories');
  }
