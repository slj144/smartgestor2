...
// Translate
import { StockAdjustmentTypesTranslate } from "./stock-adjustment-types.translate";

// Interfaces
import { IBatch } from "@itools/interfaces/IBatch";
import { ICollection } from '@itools/interfaces/ICollection';
import { IStockAdjustmentType } from "@shared/interfaces/IStockAdjustmentType";
...
export class StockAjustmentTypesService {

  public translate = StockAdjustmentTypesTranslate.get();
  ...
  public getTypes(listenerId: string, listener: ((_: any)=>void)) {
  ...
  public async registerType(data: IStockAdjustmentType, batch?: IBatch): Promise<void> {
  ...
  public async deleteType(data: IStockAdjustmentType, batch?: IBatch): Promise<void> {
  ...
  private async systemLogs(data: IStockAdjustmentType, action: string, batch: IBatch, batchRef?: number) {
    ...
    settings.data[0].type = ESystemLogType.StockLogTypes;
  ...
  private collRef(): ICollection {
    return this.iToolsService.database().collection('StockAdjustmentTypes');
  }
