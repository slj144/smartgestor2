...
export class ProductsCategoriesTranslate {
  ...
  public static get(language?: string) {
    return ProductsCategoriesTranslate.obj[language ?? window.localStorage.getItem('Language') ?? ProjectSettings.companySettings().language];
  }
