...
// Translate
import { ProductsCategoriesTranslate } from "./products-categories.translate";

// Interfaces
import { IBatch } from '@itools/interfaces/IBatch';
import { ICollection } from '@itools/interfaces/ICollection';
import { IStockProductCategory } from '@shared/interfaces/IStockProductCategory';
...
export class ProductCategoriesService {
  ...
  public translate = ProductsCategoriesTranslate.get();
  ...
  public async registerCategory(data: IStockProductCategory, batch?: IBatch): Promise<void> {
  ...
  public async deleteCategory(data: IStockProductCategory, batch?: IBatch): Promise<void> {
  ...
  private async systemLogs(data: IStockProductCategory, action: string, batch: IBatch, batchRef?: number) {
    ...
    settings.data[0].type = ESystemLogType.StockProductCategories;
  ...
  private collRef(): ICollection {
    return this.iToolsService.database().collection('StockProductCategories');
  }
