...
@Component({
  selector: 'carriers-register',
  templateUrl: './register.component.html',
  styleUrls: ['./register.component.scss']
})
export class CarriersRegisterComponent implements OnInit {

  @Output() public callback: EventEmitter<any> = new EventEmitter(); 

  public translate = CarriersTranslate.get()['modal']['action']['register'];

  public formCarrier: FormGroup;
  public settings: any = {};

  public checkBootstrap: boolean = false;
  public checkSearchPostCode: boolean = false;
  public checkActiveForm: boolean = false;

  public dropdown: any = {
    address: false, contacts: false
  };
  ...
  public get formControls() {
    return this.formCarrier.controls;
  }  
  ...
  public onSubmit() {
    ...
    const formData = this.formCarrier.value;
    const source = this.settings.data;

    const data: IRegistersCarrier = {
      _id: source._id,
      code: source.code,
    ...
    if (formData.type) {
      ...
      if (this.isBrazil) {
        ...
        // if (formData.type == 'naturalPerson') {
        //   data.personalDocument = { type: EPersonalDocument.GENERAL, value: formData.personalDocument };
        // }else if (formData.type == 'legalPerson') {
        //   data.businessDocument = { type: EBusinessDocument.GENERAL, value: formData.businessDocument };
        // }
      }      
    }
    ...
    this.carriersService.registerCarrier(data).then(() => {
