...
@Component({
  selector: 'carriers-data-export',
  templateUrl: './dataExport.component.html',
  styleUrls: ['./dataExport.component.scss']
})
export class CarriersDataExportComponent implements OnInit {

  @Output() public callback: EventEmitter<any> = new EventEmitter(); 

  public translate = CarriersTranslate.get()['modal']['action']['others']['dataExport'];
  ...
  public onExport() {
    ...
    this.carriersService.query([], false, false).then((data) => {
