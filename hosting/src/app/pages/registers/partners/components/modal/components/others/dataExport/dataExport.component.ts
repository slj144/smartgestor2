...
@Component({
  selector: 'partners-data-export',
  templateUrl: './dataExport.component.html',
  styleUrls: ['./dataExport.component.scss']
})
export class PartnersDataExportComponent implements OnInit {

  @Output() public callback: EventEmitter<any> = new EventEmitter(); 

  public translate = PartnersTranslate.get()['modal']['action']['others']['dataExport'];
  ...
  public onExport() {
    ...
    this.partnersService.query([], false, false, false, false).then((data) => {
