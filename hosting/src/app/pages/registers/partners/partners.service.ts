...
export class PartnersService {
  ...
  private data: { [_id: string]: IRegistersPartnerCompany } = {};
  ...
  public query(where?: query['where'], reset: boolean = true, flex: boolean = false, scrolling: boolean = false, strict: boolean = true) {
    ...
    return (new Promise<IRegistersPartnerCompany[]>((resolve) => {
  ...
  public getPartners(listenerId: string, listener: ((_: any)=>void)) {
  ...
  public async registerPartner(data: IRegistersPartnerCompany, batch?: IBatch): Promise<void> {
  ...
  public async deletePartner(data: IRegistersPartnerCompany, batch?: IBatch): Promise<void> {
  ...
  public getPartnersCount(listenerId: string, listener: ((_: any)=>void)) {
  ...
  private async systemLogs(data: IRegistersPartnerCompany, action: string, batch: IBatch, batchRef?: number) {
    ...
    settings.data[0].type = ESystemLogType.RegistersPartners;
  ...
  private collRef(settings?: query): ICollection {
    ...
    const collection = this.iToolsService.database().collection('RegistersPartnerCompanies');
  ...
  private requestData(settings: query, strict: boolean) {
    ...
    return (new Promise<IRegistersPartnerCompany[]>((resolve, reject) => {
  ...
  private treatData(id: string, data?: IRegistersPartnerCompany[]) {
